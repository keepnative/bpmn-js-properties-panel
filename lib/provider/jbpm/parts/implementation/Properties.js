...
/**
 * Get all jbpm:property objects for a specific business object
 *
 * @param  {ModdleElement} parent
 *
 * @return {Array<ModdleElement>} a list of jbpm:property objects
 */
...
/**
 * Get all jbpm:Properties object for a specific business object
 *
 * @param  {ModdleElement} parent
 *
 * @return {ModdleElement} a jbpm:Properties object
 */
...
/**
 * Get first jbpm:Properties object for a specific bpmn:ExtensionElements
 * business object.
 *
...
function getPropertiesElementInsideExtensionElements(extensionElements) {
  return find(extensionElements.values, function(elem) {
    return is(elem, 'jbpm:Properties');
  });
}
...
/**
 * Create a jbpm:property entry using tableEntryFactory
 *
...
module.exports = function(element, bpmnFactory, options) {
  ...
  assign(options, {
    ...
    addElement: function(element, node) {
      ...
      if (!properties) {
        properties = elementHelper.createElement('jbpm:Properties', {}, parent, bpmnFactory);
      ...
      var property = elementHelper.createElement('jbpm:Property', propertyProps, properties, bpmnFactory);
    ...
    removeElement: function(element, node, idx) {
      ...
      if (propertyValues.length === 1) {
        // remove jbpm:properties if the last existing property has been removed
        if (!isExtensionElements(parent)) {
